...
public class AnimationFollowing : MonoBehaviour
{
    ...
    private Vector3[] rigidbodiesPosToCOM;  // idk what this is
    ...
    // USEFUL VARIABLES
    public bool isAlive;
    public float forceCoefficient = 1.0f; // This is set by ragdollControll script in real time. Controls force applied to limbs.
    public float torqueCoefficient = 1.0f; // This is set by ragdollControll script in real time. Controls torque applied to limbs.
    private bool[] limbProfile = { true, true, true, true, true, true, true, true, true, true, true }; // This is set by ragdollControll script in real time. False means no force will be applied to specified limb.
    ...
    void Start()
    {
        ...
        int numOfRigids = slave.GetComponentsInChildren<Rigidbody>().Length;
        Debug.Log(numOfRigids);
        ...
        foreach (Transform t in slaveRigidTransforms) // Set some of the Unity parameters
        {
    ...
    // Update is called once per each physics update
    void FixedUpdate()
    {
        // This is called by ragdoll control:
        // FollowAnimation();
    }
    ...
    public void FollowAnimation()
    {
        ...
        for (int i = 0; i < slaveRigidTransforms.Length; i++) // Do for all rigid bodies
        {
            ...
            /*
                        rb.angularDrag = angularDrag; // Set rigidbody drag and angular drag in real-time
                        rb.drag = drag;
            */
