...
public class AnimationFollowing : MonoBehaviour
{
    ...
    private Transform slaveRoot;     // ragdoll hips
    private Transform masterRoot;    // static animator hips
    ...
    void Start()
    {
        ...
        slaveTransforms = slaveRoot.GetComponentsInChildren<Transform>(); // Get all transforms in ragdoll.
        masterTransforms = masterRoot.GetComponentsInChildren<Transform>(); // Get all transforms in master. 
        ...
        numOfRigids = slaveRoot.GetComponentsInChildren<Rigidbody>().Length;
